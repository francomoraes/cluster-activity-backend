...
router.get('/', checkToken, workspaceController.getAll.bind(workspaceController));
router.get('/user', checkToken, workspaceController.getAllByUser.bind(workspaceController));
router.get('/:workspaceId', checkToken, workspaceController.getById.bind(workspaceController));
router.patch(
    '/:workspaceId',
    checkToken,
    checkOwnership('workspace', 'workspaceId'),
...
router.post(
    '/:workspaceId/join',
    checkToken,
    workspaceController.joinWorkspace.bind(workspaceController)
);
router.post(
    '/:workspaceId/leave',
    checkToken,
